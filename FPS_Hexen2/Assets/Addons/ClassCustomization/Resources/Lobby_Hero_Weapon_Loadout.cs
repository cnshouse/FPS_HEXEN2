...
public class Lobby_Hero_Weapon_Loadout :  MonoBehaviour
{
    ...
    public void SetUpClasses(bl_GunManager gm)
    {
        ...
        //gm.PlayerEquip[4] = gm.GetGunOnListById(pcl.Knife);
        //gm.PlayerEquip[5] = gm.GetGunOnListById(pcl.Special);
    ...
    private static Lobby_Hero_Weapon_Loadout _instance;
    public static Lobby_Hero_Weapon_Loadout Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = Resources.Load<Lobby_Hero_Weapon_Loadout>("Lobby_Hero_Weapon_Loadout") as Lobby_Hero_Weapon_Loadout;
            }
            return _instance;
        }
    }
