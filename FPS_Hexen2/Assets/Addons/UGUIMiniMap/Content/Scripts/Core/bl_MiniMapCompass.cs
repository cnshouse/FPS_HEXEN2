...
public class bl_MiniMapCompass : bl_MonoBehaviour {
    ...
    void Start()
    {
        ...
        if (!CompassRoot.gameObject.activeSelf) { this.enabled = false; }
    }
    ...
    public override void OnUpdate()
    {
        ...
        {
            if (bl_GameManager.Instance.CameraRendered == null) return;

            Vector3 north = Vector3.forward * 1000;
            Vector3 tar = bl_GameManager.Instance.CameraRendered.transform.forward;
            tar.y = 0;
