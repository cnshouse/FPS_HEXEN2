...
Shader "MFPS/MFPSWater"
{
	...
	SubShader
	{
		...
		{
			float2 temp_cast_0 = (( _Time.y / 100.0 )).xx;
			float2 uv_TexCoord18 = i.uv_texcoord * float2( 30,30 ) + temp_cast_0;
			float2 temp_cast_1 = (( _Time.y / -70.0 )).xx;
			float2 uv_TexCoord19 = i.uv_texcoord * float2( 20,20 ) + temp_cast_1;
