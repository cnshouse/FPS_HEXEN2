...
public class bl_LobbyRoomCreator : MonoBehaviour, IConnectionCallbacks, ILobbyCallbacks
{
    ...
    #region Getters
    public bl_GameData.SceneInfo Map => MapList[bl_LobbyRoomCreatorUI.Instance.Map];
    ...
    public GameModeSettings GameModeInfo => bl_Lobby.Instance.GameModes[bl_LobbyRoomCreatorUI.Instance.GameMode];
    ...
    public RoundStyle PerRoundGame => bl_LobbyRoomCreatorUI.Instance.GamePerRound;
    ...
    private List<bl_GameData.SceneInfo> m_mapList;
    public List<bl_GameData.SceneInfo> MapList
    {
        get
        {
